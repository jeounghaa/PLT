...
<style type="text/css">
body {
	background-image: url("https://jha1bucket.s3.us-east-2.amazonaws.com/sky2.png");
	padding: 30px;
	margin: 0 auto;
	width: 1300px;
...
<body>
	<header>
		<img alt="전찾시 로고" src="https://jha1bucket.s3.us-east-2.amazonaws.com/kakaoQR.png" width="100" height="100"><span id="logo">전찾시</span>
